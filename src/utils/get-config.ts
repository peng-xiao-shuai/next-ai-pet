...
export const getAppConfigEnv = (
  ...
  if (origin.includes('https://www.telegramloveai.com')) {
    ...
    return {
      ...
      TG_APP_NAME: 'test',
      origin,
      HOST: 'https://http://ai-love-pet-322313939.us-west-2.elb.amazonaws.com',
      WSS: 'wss://http://ai-love-pet-322313939.us-west-2.elb.amazonaws.com/',
      OSS: 'https://static.ailov3.com/',
      DOWNLOADAPI:
        'https://http://ai-love-pet-322313939.us-west-2.elb.amazonaws.com/util/file/download/',
      APPVERSIONCODE: 101,
      APPTYPE: 'H5',
      APPNAME: 'Ai girl friend',
      GOOGLE_GAID: 'G-46HPB8YJYG',
