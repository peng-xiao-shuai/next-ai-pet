    ...
    >
      ...
      >
        <div>
          <div
            className={cn(
              'bg-[#1D1C21] rounded-2xl h-12 flex items-center px-2 flex-1 border-[#FF2F53]',
          ...
          {Boolean(errorMsg) && (
            <div className="text-[#FF2F53] text-xs">{errorMsg}</div>
          )}
        </div>

        <span className="text-lg">Feed all</span>
      </div>
