...
const lang = {
  ...
  [LOCALE_KEYS.SEND_MESSAGES_TO_EARN_$PETS]:
    'Отправить сообщение и заработать $AIPets',
  ...
  [LOCALE_KEYS.THANK_YOU_FOR_FEEDING]:
    'Спасибо, что покормили меня, мой хозяин! Этот корм улучшил ${0} емкость $AIPets',
  [LOCALE_KEYS.CAPACITY_DESCRIPTION]:
    'Чем больше кормите собачьим кормом, тем больше $AIPets вы зарабатываете во время чата и взаимодействия, чем больше кормите, тем больше $AIPets вы зарабатываете за одинаковые чаты и взаимодействия!',
